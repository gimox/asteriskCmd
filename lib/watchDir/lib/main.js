module.exports = function (app) {
    ...
    function normalizeDir() {
        ...
        logger.debug('Start normalizing outgoind dir: '+outgoingDir);
        ...
        if (countOutgoing > line) {
            ...
            logger.debug('Outgoing dir max number file ok');
        }
    }
    ...
    function checkOutgoing(){
        logger.debug('watching outgoing dir files..');
        fs.watch(outgoingDir, function (event, filename) {
